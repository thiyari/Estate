...
const Sidebar = () => {
  ...
  return (
      <CDBSidebar className="border" maxWidth="230px" textColor="#333" backgroundColor="#f8f9fb">
        ...
        <CDBSidebarContent>
          <CDBSidebarMenu>
            ...
            <NavLink exact="true" to="/Properties" className={(navData) => (navData.isActive ? "active-style" : 'none')}>
